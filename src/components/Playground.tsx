...
const ITEMS: PlayItem[] = [
  {
    ...
    x: 160, y: 200, width: 320, height: 220,
  ...
  },
  {
    ...
    x: 560, y: 60, width: 210, height: 300,
  ...
  },
  {
    ...
    x: 850, y: 180, width: 380, height: 250,
    visualStyle: {
      background: [
  ...
  },
  {
    ...
    x: 1310, y: 100, width: 240, height: 230,
  ...
  },
  {
    ...
    x: 1640, y: 60, width: 280, height: 380,
    visualStyle: { background: 'linear-gradient(135deg, #f5e6d3 0%, #e8c9a0 100%)' },
    label: '01',
    labelStyle: { fontSize: '130px', color: 'rgba(0,0,0,0.07)', fontFamily: 'Georgia, serif', lineHeight: '1', fontWeight: '700' },
  },
  {
    id: 6,
    title: 'Type Study: Grotesque',
    desc: 'Letterform anatomy and optical correction',
    x: 80, y: 500, width: 250, height: 310,
    visualStyle: { background: '#1c1c1c' },
    label: 'Gg',
    labelStyle: { fontSize: '108px', color: 'rgba(255,255,255,0.15)', fontFamily: 'Georgia, serif', lineHeight: '1', letterSpacing: '-4px' },
  },
  {
    id: 7,
    title: 'Botanical Study',
    desc: 'Watercolor-style gradient experiments',
    x: 430, y: 530, width: 310, height: 220,
  ...
  },
  {
    ...
    x: 1120, y: 430, width: 220, height: 280,
  ...
  },
  {
    ...
    x: 1960, y: 140, width: 350, height: 260,
    visualStyle: {
      background: '#f5f5f0',
  ...
  },
  {
    ...
    x: 2010, y: 480, width: 270, height: 330,
  ...
  },
  {
    ...
    x: 330, y: 820, width: 290, height: 360,
    visualStyle: { background: 'conic-gradient(from 0deg at 50% 50%, #ffeaa7, #fd79a8, #a29bfe, #74b9ff, #55efc4, #ffeaa7)' },
  },
  {
    id: 12,
    title: 'Brand Identity',
    desc: 'Visual identity system — studio mark',
    x: 900, y: 810, width: 300, height: 220,
    visualStyle: { background: '#2d3561' },
    label: 'SC',
    labelStyle: { fontSize: '72px', color: 'rgba(255,255,255,0.12)', fontWeight: '700', letterSpacing: '10px', fontFamily: 'sans-serif' },
  },
  {
    id: 13,
    title: 'Pastels Collection',
    desc: 'Color swatches — pastel tone study',
    x: 1420, y: 660, width: 290, height: 240,
    visualStyle: { background: 'linear-gradient(90deg, #ffeaa7 25%, #fdcb6e 25% 50%, #fd79a8 50% 75%, #a29bfe 75%)' },
  },
  {
    id: 14,
    title: 'Sunset Chromatics',
    desc: 'Analogous color harmony exploration',
    x: 2340, y: 190, width: 300, height: 250,
  ...
  },
  {
    ...
    x: 2450, y: 510, width: 240, height: 320,
  ...
  },
  {
    ...
    x: 1200, y: 760, width: 200, height: 200,
...
export function Playground() {
  ...
  // Wheel scroll handler (non-passive to allow preventDefault)
  useEffect(() => {
  ...
  return (
    <section id="playground" className="playground-section">
      <p className="section-label playground-label">Playground</p>
      <div
        ref={containerRef}
